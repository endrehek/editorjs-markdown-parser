...
class Du {
  ...
  */
   ...
   */
  render() {
    this.wrapper = document.createElement("div"), this.wrapper.classList.add("cdx-block"), this.stringUploadInput = document.createElement("textarea"), this.stringUploadInput.value = this.data && this.data.filename ? this.data.filename : "", this.stringUploadInput.classList.add("cdx-input"), this.wrapper.appendChild(this.stringUploadInput), this.stringUploadButton = document.createElement("button"), this.stringUploadButton.classList.add("cdx-button"), this.stringUploadButton.innerHTML = "Load Markdown", this.stringUploadButton.onclick = () => this.stringUploadInput.value !== "" ? this.parse(this.stringUploadInput.value) : (this.api.blocks.delete(this.api.blocks.getCurrentBlockIndex()), this.parse(" ")), this.wrapper.appendChild(this.stringUploadButton);
